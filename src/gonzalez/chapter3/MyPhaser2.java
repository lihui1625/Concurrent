...
public class MyPhaser2 implements Runnable {
	...
	public MyPhaser2(String initPath, String end, Phaser phaser) {
...
class Main {
	...
	public static void main(String[] args) {
		...
		MyPhaser2 system = new MyPhaser2("C:\\Windows", "log", phaser);
		MyPhaser2 apps = new MyPhaser2("C:\\Program Files", "log", phaser);
		MyPhaser2 documents = new MyPhaser2("C:\\Documents And Settings",
				"log", phaser);
